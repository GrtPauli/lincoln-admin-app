...
export default function PostNews({ news }: any) {
  ...
  const update = async (values: any) => {
    ...
    ApiService.post(`/news/update/${news?.code}`, formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    })
  ...
  return (
    <View className="flex-1">
      <Formik
        initialValues={{
          title: news ? news?.post_title : "",
          description: news ? news?.post_content : "",
        }}
